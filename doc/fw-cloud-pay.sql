...
-- 正在导出表  fw-cloud-pay.t_pay_channel 的数据：~4 rows (大约)
...
INSERT INTO `t_pay_channel` (`id`, `channel_id`, `channel_name`, `channel_mch_id`, `mch_id`, `statu`, `param`, `remark`, `create_time`, `update_time`) VALUES
	(1, 'WX_JSAPI', 'WX', '111111', '10000001', 1, '{"mchId":"111111", "appId":"xxxsss", "key":"xxxxxx", "certLocalPath":"wx/apiclient_cert.p12", "certPassword":"xxxxxx"}', '', '2017-11-20 10:08:54', '2017-11-21 13:26:57');
...
INSERT INTO `t_pay_mch_info` (`id`, `mch_id`, `mch_name`, `type`, `req_key`, `res_key`, `statu`, `create_time`, `update_time`) VALUES
	(1, '10000001', '广东xxxxx', '1', 'REQKEY_xxxxxx', 'RESKEY_xxxxx', 1, '2018-03-19 11:07:55', '2018-03-26 13:57:08');
...
-- 正在导出表  fw-cloud-pay.t_pay_order 的数据：~17 rows (大约)
