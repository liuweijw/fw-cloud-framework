...
import com.github.liuweijw.business.pay.core.beans.NotifyReqBean;
import com.github.liuweijw.business.pay.core.utils.PayDigestUtil;
...
public class NotifyServiceImpl implements NotifyService {
	...
	public void notifyPayOrder(NotifyBean notifyBean, int count) {
		rabbitTemplate.convertAndSend(RabbitConfiguration.PAY_NOTIFY_DELAY_PRE_MESSAGE_TTL, notifyBean, new MessagePostProcessor(){
			@Override
