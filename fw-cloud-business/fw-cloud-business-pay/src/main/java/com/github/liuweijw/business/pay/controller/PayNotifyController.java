...
public class PayNotifyController {
	...
	@ResponseBody public String notifyResult(HttpServletRequest request, HttpServletResponse response) {
	...
	@ResponseBody public String notifyTest(@PathVariable String payOrderId) {
